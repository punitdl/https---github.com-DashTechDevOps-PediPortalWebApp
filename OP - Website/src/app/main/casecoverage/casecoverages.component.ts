...
@Component({
    selector     : 'casecoverage',
    templateUrl  : './casecoverages.component.html',
    styleUrls    : ['./casecoverages.component.scss'],
    encapsulation: ViewEncapsulation.None,
    animations   : fuseAnimations
})
export class CasecoveragesComponent implements OnInit, OnDestroy
{
    dialogRef: any;
