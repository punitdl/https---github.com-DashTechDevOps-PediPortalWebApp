...
@Component({
    selector   : 'usermanagements-main-sidebar',
    templateUrl: './main.component.html',
    styleUrls  : ['./main.component.scss']
})
export class UsermanagementsMainSidebarComponent implements OnInit, OnDestroy
{
    user: any;
    filterBy: string;
    ...
    ngOnInit(): void
    {
        this.filterBy = this._usermanagementsService.filterBy || 'all';
    ...
    changeFilter(filter): void
    {
        ...
        this._usermanagementsService.onFilterChanged.next(this.filterBy);
    }
}
